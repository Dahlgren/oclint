...
class url:
    ...
    clang_prebuilt_binary_for_macos = 'https://releases.llvm.org/6.0.0/clang+llvm-6.0.0-x86_64-apple-darwin.tar.xz'
    clang_prebuilt_binary_for_ubuntu_lts_14 = 'https://releases.llvm.org/6.0.0/clang+llvm-6.0.0-x86_64-linux-gnu-ubuntu-14.04.tar.xz'
